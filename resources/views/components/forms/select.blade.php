...
@php
$themes = [
'default' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
...
<select {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge(['class' => $themes[$theme]]) !!}>
