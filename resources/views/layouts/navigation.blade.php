                ...
                <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <div class="grid grid-cols-3 gap-4 p-4">
                        <a href="{{route('home')}}"
                            ...
                            <x-icons.dashboard class="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400" />
                        ...
                        <a href="#" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                            <x-icons.job-desc />
                            <div class="text-sm font-medium text-gray-900 dark:text-white">Job Desc</div>
                        </a>
                        ...
                        <a href="{{route('project.index')}}"
                            class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                            <x-icons.project class="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400" />
                            <div class="text-sm font-medium text-gray-900 dark:text-white">Project</div>
                        </a>
                        <a href="{{route('activity.index')}}"
                            class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                            <x-icons.activity class="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400" />
                            <div class="text-sm font-medium text-gray-900 dark:text-white">Activity</div>
                        </a>
                        <a href="{{route('timeline.index')}}"
                            class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                            <x-icons.timeline class="mx-auto mb-1 text-gray-500 w-7 h-7 dark:text-gray-400" />
