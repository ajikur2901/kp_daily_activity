        ...
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg max-w-xl">
            ...
            <form method="POST" action="{{ route('user.update',$user) }}">
                ...
                <div class="mb-3">
                    ...
                    <x-forms.text-input type="text" placeholder="name" name="name" value="{{ $user->name }}"
                        autocomplete="off" :theme="$themeName" />
                ...
                <div class="mb-3">
                    ...
                    <x-forms.text-input type="email" placeholder="email" name="email" value="{{ $user->email }}"
                        autocomplete="off" :theme="$themeEmail" />
                ...
                <div class="mb-3">
                    ...
                    <x-forms.text-input type="password" placeholder="password" name="password"
                        value="{{ old('password') }}" autocomplete="off" :theme="$themePassword" />
                ...
                <div class="mb-3">
                    ...
                    <x-forms.text-input type="password" placeholder="password" name="password_confirmation"
                        value="{{ old('password_confirmation') }}" autocomplete="off" :theme="$themePassword" />
